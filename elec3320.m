...
%plotting probes
time_vector = (0:length(E0)-1) * deltat;
figure
subplot(2,1,1)
plot(time_vector*1e6, E0, 'LineWidth', 1.5)
xlabel('Time (\mus)')
ylabel('E0 (V/m)')
title('Electric Field at Probe 0 (in air)')
grid on


subplot(2,1,2)
plot(time_vector*1e6, E1, 'LineWidth', 1.5)
xlabel('Time (\mus)')
ylabel('E1 (V/m)')
title('Electric Field at Probe 1 (in medium)')
grid on
